from live_platform.huya.plugins.huya_wup.wup_struct.OnTVData import HuyaOnTVData
from live_platform.huya.plugins.huya_wup.wup_struct.OnTVSettingInfo import HuyaOnTVSettingInfo
