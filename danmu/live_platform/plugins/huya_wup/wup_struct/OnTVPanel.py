from live_platform.plugins.huya_wup.wup_struct.OnTVCfgDiy import HuyaOnTVCfgDiy
from live_platform.plugins.huya_wup.wup_struct.OnTVGameInfo import HuyaOnTVGameInfo
from live_platform.plugins.huya_wup.wup_struct.OnTVAwardInfo import HuyaOnTVAwardInfo
